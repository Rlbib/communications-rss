(function () {
        ...
        style.textContent = `
            ...
            /* LIGNE FUSIONNÉE EN BAS DU TABLEAU 1 */
        ...
        overlayHTML.innerHTML = `
            <div class="md">
                ...
                <div class="mb">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" class="fp-banner-td">
                                        <div class="fp-banner-title"><i class="fa fa-info-circle"></i> Modalités de consultation du Fonds patrimonial :</div>
                                        <ul class="fp-banner-list">
                                            <li>Sur rendez-vous uniquement.</li>
                                            <li>Les demandes doivent être transmises à <a href="mailto:bibliotheques@agglopolys.fr">bibliotheques@agglopolys.fr</a> au moins 24h avant le rendez-vous.</li>
                    ...
                    <div class="tw">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><strong>Fonds patrimonial</strong></td>
                                    <td colspan="5" style="text-align: center; vertical-align: middle; font-style: italic; background: var(--light); color: var(--muted);">
                                        <i class="fa fa-calendar-check-o"></i> Uniquement sur rendez-vous
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="ft">
                        <i class="fa fa-info-circle"></i> Fermé le dimanche et le lundi.
                    </div>
                </div>
            </div>
        `;
        ...
        const closures = {
            ...
            fp: { start: new Date(currentYear, 7, 11), end: new Date(currentYear, 7, 14) }
        };
        ...
        const regularHours = {
            ...
            fp: { 0: null, 1: null, 2: null, 3: null, 4: null, 5: null, 6: null }
        };
        ...
        const summerHours = {
            ...
            fp: { 0: null, 1: null, 2: null, 3: [{ s: 10, e: 13 }], 4: [{ s: 10, e: 13 }], 5: [{ s: 10, e: 13 }], 6: null }
        };
