...
+'.ms{font-size:15px;font-weight:700;color:var(--dark);margin:24px 0 14px;padding-bottom:8px;border-bottom:2px solid var(--acc);display:flex;align-items:center;gap:8px;flex-wrap:wrap;}'
...
+'.tbl-off tbody tr:hover td{background:var(--light);}'
...
+'  font-size:11.5px;color:var(--red);font-weight:600;line-height:1.4;'
+'}'
+'.note-na i{font-size:13px;flex-shrink:0;}'
+''
...
+'  .badge-na{font-size:9px;padding:2px 8px;}'
+'  .note-na{font-size:10.5px;padding:8px 10px;}'
